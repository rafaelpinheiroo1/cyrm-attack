...
def topology(args):
    ...
    henrique = net.addDocker('henrique', mac='00:00:00:00:00:70', ip='10.0.20.103/24', dimage="ddos-attack:latest", defaultRoute='via 10.0.20.254')
    joyce = net.addDocker('joyce', mac='00:00:00:00:00:80', ip='10.0.20.104/24', dimage="ddos-attack:latest", defaultRoute='via 10.0.20.254')
    internet = net.addDocker('internet', mac='00:00:00:00:00:90', ip='1.178.218.56/24', dimage="dic-attack-ssh:latest", defaultRoute='via 1.178.218.254')
